...
export const ERROR_MESSAGES = {
  ...
  PROFILE_FORBIDDEN: "You can only manage your own profile",
  PASSWORD_OAUTH_FORBIDDEN:
    "Password can only be set on email/password accounts",
  ...
  AVATAR_FILE_NOT_FOUND: "Profile picture file not found",
