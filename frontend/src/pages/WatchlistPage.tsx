            ...
            >
              ...
              {m.watched && (
                <>
                  ...
                  <span className="absolute top-2 left-2 inline-flex items-center gap-1 rounded-md bg-emerald-500 px-2 py-1 text-[10px] sm:text-[11px] font-bold uppercase tracking-wide text-white shadow-lg">
                    <svg
