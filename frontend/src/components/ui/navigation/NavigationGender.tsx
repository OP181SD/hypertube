    ...
    <div className="relative w-full my-4 py-4 bg-white/3 backdrop-blur-sm border-y border-white/6">
      ...
      <div className="flex flex-wrap justify-center items-center gap-4 mt-3 px-4 sm:px-6">
        <div className="flex items-center gap-2.5">
          <label htmlFor="filter-min-rating" className="text-[11px] sm:text-xs text-white/40 tracking-wide">{t("min_rating")}:</label>
          <select
        ...
        <div className="flex items-center gap-2.5">
          <label htmlFor="filter-min-year" className="text-[11px] sm:text-xs text-white/40 tracking-wide">{t("year")}:</label>
          <input
            id="filter-min-year"
            type="number"
            name="minYear"
