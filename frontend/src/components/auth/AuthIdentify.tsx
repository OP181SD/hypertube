  ...
  return (
    <div className="flex flex-col gap-8 p-12 pt-12.5 pb-7.5 bg-[#1c1c1e]">
      <div className="flex flex-col items-center gap-1">
        <div className="flex items-center text-[28px] font-semibold tracking-tight">
          <span className="text-white/90">Hyper</span><span className="colors-title-gradient">Tube</span>
        </div>
      ...
      <div className="flex flex-col items-center gap-4 mt-2">
        ...
        <OAuthProviders className="grid grid-cols-2 gap-2 w-full max-w-90" />
