...
import { Action, goToIdentify } from "./types";
      ...
      <div className="flex grow flex-col items-center gap-4">
        ...
        <div className="flex justify-end gap-4 mt-auto pt-4 border-t border-[#424245] w-full">
          ...
          <button
            ...
            className="px-4 py-2 cursor-pointer rounded-full bg-[#0071e3] text-white font-medium hover:bg-[#0077ed] transition-colors"
          >
            {t("continue")}
          </button>
        </div>
